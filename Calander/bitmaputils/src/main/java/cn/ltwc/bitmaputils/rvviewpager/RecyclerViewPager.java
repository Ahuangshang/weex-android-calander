package cn.ltwc.bitmaputils.rvviewpager;
...
public class RecyclerViewPager extends RecyclerView {
    ...
    public void scrollToPosition(int position) {
        LogUtil.d("scrollToPosition:" + position);
        mPositionBeforeScroll = getCurrentPosition();
        mSmoothScrollTargetPosition = position;
    ...
    protected void adjustPositionX(int velocityX) {
        ...
        if (childCount > 0) {
            ...
            if (mSinglePageFling) {
                ...
                LogUtil.d( "flingCount:" + flingCount);
                LogUtil.d( "original targetPosition:" + targetPosition);
            }
            ...
            LogUtil.d( "mTouchSpan:" + mTouchSpan);
            LogUtil.d("adjustPositionX:" + targetPosition);
    ...
    protected void adjustPositionY(int velocityY) {
        ...
        if (childCount > 0) {
            ...
            LogUtil.d( "mTouchSpan:" + mTouchSpan);
            LogUtil.d( "adjustPositionY:" + targetPosition);
            smoothScrollToPosition(safeTargetPosition(targetPosition, getItemCount()));
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        try {
            if (ev.getAction() == MotionEvent.ACTION_DOWN && getLayoutManager() != null) {
                ...
                LogUtil.d( "mPositionOnTouchDown:" + mPositionOnTouchDown);
                mLastY = ev.getRawY();
            }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == SCROLL_STATE_DRAGGING) {
            ...
            if (mCurView != null) {
                ...
                LogUtil.d("mPositionBeforeScroll:" + mPositionBeforeScroll);
            ...
            if (mNeedAdjust) {
                ...
                LogUtil.d("onPageChanged:" + mSmoothScrollTargetPosition);
