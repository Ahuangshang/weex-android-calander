...
//    }
    private void initViews(Context context) {
        ...
        mIvTv = (ImageView) findViewById(R.id.iv_tv);
    ...
    public void onClick(View view) {
        ...
        if (i == R.id.iv_back || i == R.id.tv_title) {
            ...
            hide();
            if (tvIconListener != null) {
                tvIconListener.tvMenuClick();
            }
        }
    }
...
//    }
    ...
    @Override
    public void onWindowModelChange(int model) {
        mVodController.windowModel(model);
    }
    ...
    @Override
    public void onOverTurn(boolean isOverTurn) {
        mVodController.onOverTurn(isOverTurn);
    }
