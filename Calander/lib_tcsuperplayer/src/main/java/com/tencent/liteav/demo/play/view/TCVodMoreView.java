...
public class TCVodMoreView extends RelativeLayout implements RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void init(Context context) {
        ...
        mRadioWindow = (RadioGroup) findViewById(R.id.radioGroup_window);
        mRbWindow1 = (RadioButton) findViewById(R.id.rb_window1);
        mRbWindow2 = (RadioButton) findViewById(R.id.rb_window2);


        mRadioGroup.setOnCheckedChangeListener(this);
        mRadioWindow.setOnCheckedChangeListener(this);
        ...
        mSwitchOverTurn = findViewById(R.id.switch_overturn);
        ...
        mSwitchOverTurn.setOnCheckedChangeListener(this);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        ...
        } else if (compoundButton.getId() == R.id.switch_overturn) {
            if (mCallback != null) {
                mCallback.onOverTurn(isChecked);
                setVisibility(GONE);
            }
        }
    }
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
        ...
        } else if (checkedId == R.id.rb_window1) {
            mRbWindow1.setChecked(true);
            if (mCallback != null) {
                mCallback.onWindowModelChange(TXLiveConstants.RENDER_MODE_ADJUST_RESOLUTION);
            }
        } else if (checkedId == R.id.rb_window2) {
            mRbWindow2.setChecked(true);
            if (mCallback != null) {
                mCallback.onWindowModelChange(TXLiveConstants.RENDER_MODE_FULL_FILL_SCREEN);
            }
        }
    }
