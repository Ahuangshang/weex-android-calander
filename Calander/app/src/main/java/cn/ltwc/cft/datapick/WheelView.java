...
/**
 * TODO:Numeric wheel view.
 *
 * @author huangshang 2015-11-21 上午1:23:07
 * @Modified_By:
 */
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xFF006FFF;
     ...
     */
    private static final int ADDITIONAL_ITEMS_SPACE = BitMapUtil.dip2px(
            MyApplication.getInstance(), 5);
    ;

    /**
     * Label offset
     */
    private static final int LABEL_OFFSET = BitMapUtil.dip2px(
            MyApplication.getInstance(), 4);
    ;

    /**
     * Left and right padding value
     */
    private static final int PADDING = BitMapUtil.dip2px(
            MyApplication.getInstance(), 5);
    ;
    ...
    /**
     * Sets the current item_show_img. Does nothing when index is wrong.
     *
     * @param index    the item_show_img index
    ...
    /**
     * Sets the current item_show_img w/o animation. Does nothing when index is wrong.
     *
     * @param index the item_show_img index
     */
    ...
    /**
     * Tests if wheel is cyclic. That means before the 1st item_show_img there is shown
     * the last one
     *
    ...
    /**
     * Returns text item_show_img by index
     *
     * @param index the item_show_img index
     * @return the item_show_img or null
     */
    ...
    /**
     * Returns the max item_show_img length that can be present
     *
    ...
    /**
     * Returns height of wheel item_show_img
     *
     * @return the item_show_img height
     */
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        if (maxLength > 0) {
            double textWidth = Math.ceil(Layout
